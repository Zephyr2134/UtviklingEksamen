    ...
    <>
      {!lagerBruker ? (
        ...
        >
          ...
          <button onClick={() => setLagerBruker(!lagerBruker)}>Har ikke bruker?</button>
        </form>
      ) : (
        <form
          className="LagBruker"
        ...
        >
            <select required onChange={(b)=>setNyBruker(gammel=>({...gammel, rolle:b.target.value}))}>
          ...
          <input
            ...
            onChange={(b)=>setNyBruker(gammel=>({...gammel, brukernavn:b.target.value}))}
          />
          <input
            required
            type="password"
            ...
            onChange={(b)=>setNyBruker(gammel=>({...gammel, passord:b.target.value}))}
          />
          <input
            required
            placeholder="Telefon nummer"
            value={nyBruker.telefon}
            onChange={(b)=>setNyBruker(gammel=>({...gammel, telefon:b.target.value}))}
          />
          {nyBruker.rolle === "eier" && 
          <>
          <input
            ...
            onChange={(b)=>setNyBruker(gammel=>({...gammel, adresse:b.target.value}))}
          />
          ...
          <div className="HundeFelt">
            ...
            onChange={(b)=>setNyBruker(gammel => ({...gammel,hund: {...gammel.hund,navn: b.target.value}}))}
          />
          <input
            required
            ...
            onChange={(b) =>
            setNyBruker(gammel => ({...gammel,hund: {...gammel.hund,rase: b.target.value}}))}
          />
        <h3>Alder</h3>
          <input
            required
            ...
            onChange={(b) =>
            setNyBruker(gammel => ({...gammel,hund: {...gammel.hund,alder: Number(b.target.value)}}))}
          />
        <input
            required
            ...
            onChange={(b) =>
            setNyBruker(gammel => ({...gammel,hund: {...gammel.hund,spesielleBehov: b.target.value}}))}
          />
        ...
        <input
                        ...
                        {nyBruker.hundBildePlassering ? (
                          !bilde ? (
                            <img className="HundeBilde" src={nyBruker.hundBildePlassering} />
                          ) : (
                            <img className="HundeBilde" src={URL.createObjectURL(bilde)} />
                          )
                        ) : (
          ...
          <input
            ...
            onChange={(b) =>
            setNyBruker(gammel => ({...gammel,omraade:b.target.value}))}
          />
          ...
          <input
            ...
            type="number"
            onChange={(b) =>
            setNyBruker(gammel => ({...gammel,pris:Number(b.target.value)}))}
          />
          </>
          }
